...
contract DeployRaffleTest is Test {
    ...
    function testDeployRaffleOnLocalAnvil() public {
        ...
        console.log(
            "Raffle added as a consumer to subscription ID: ",
            config.subscriptionId
        );
        ...
        assertTrue(
            ...
            "Raffle contract should be deployed"
        );
        assertTrue(
        ...
        assertTrue(
            subscriptionId > 0,
            "Subscription ID should be greater than zero"
        );
        ...
        (, , , , address[] memory consumers) = coordinator.getSubscription(
            subscriptionId
        );
